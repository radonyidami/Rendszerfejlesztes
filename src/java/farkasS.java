 ...
 * @author gazda
 */
@WebServlet(urlPatterns = {"/farkasS"})
public class farkasS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String cssLocation = request.getContextPath() + "/login.css";
    ...
    String fv() {
        ...
        g = "<div class=\"topnav\" id=\"myTopnav\">\n"
                ...
                + "  <a href=\"domainServlet\"> Adatok lekérése</a>\n"
                + //"  <a href=\"beosztasServlet\">Beosztások lekérése</a>\n" +
