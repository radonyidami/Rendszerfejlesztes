 ...
 * @author gazda
 */
@WebServlet(urlPatterns = {"/beosztasServlet"})
public class beosztasServlet extends HttpServlet {
...
//    String z="";
    ...
    in.startConnection("farkas");
        ...
        try {
            rs=in.leker("select * from beosztas", 0);
//      rs.next();
